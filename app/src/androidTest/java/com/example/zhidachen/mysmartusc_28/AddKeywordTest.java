...
public class AddKeywordTest {
    ...
    public String keywordToBeTested = "qoewinfdosnvcbv";
    ...
    public void AddKeywordTest() {
        ...
        onView(withText("Keyword has been added")).inRoot(withDecorView(not(activityTestRule.getActivity().getWindow().getDecorView()))).check(matches(isDisplayed()));
    }
